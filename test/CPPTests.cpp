...
TEST(CPPTests, FolderException)
{
    ...
    ASSERT_EQ(tempLine.substr(28), "179193b9b14f97e4491a316dc82888d4b4ccdc20228f2524f565b17e41e9460b\";");
    file.close();
    file.open("../../test/folders/cpp/testFolder1/test/dummy-test.cpp");
    tempLine = GotoLine(file, 6);
    ASSERT_EQ(tempLine.substr(32), "d40b8d6251d90deeedb5d7bc594e4c338945ef19c779b28d0abd3e640aa89c09\\n\";");
    file.close();
    file.open("../../test/folders/cpp/testFolder1/utils/dummy-copy.cpp");
    tempLine = GotoLine(file, 7);
    ASSERT_EQ(tempLine.substr(70), "c4d1fa3dc28421723976ed791d2829ec2e3206b2b165cabb9b9d941ed8683421\");");
    file.close();
    file.open("../../test/folders/cpp/testFolder1/utils/dummy-multiply.cpp");
    tempLine = GotoLine(file, 6);
    ASSERT_EQ(tempLine.substr(48), "cdc40a9364ae622e2162cdfb76abccdc3e198a2289d95b81306de9eebb99670b\");");
    file.close();
}
